...
path_to_log_used_files = sys.argv[5]
...
for exp_id in ['vmp_0_8','vmp_1_2','vmp_1_6']:
    cmd = "python3 "+os.path.join(os.getenv("ROS_PROJECT_ROOT"),"other_files","execute_agent_evaluation_for_one_exp.py")+" "+str(ros_port)+" "+str(gaz_port)+" "+exp_id+" "+sim_id+" "+path_to_exp+" "+path_to_log_used_files
