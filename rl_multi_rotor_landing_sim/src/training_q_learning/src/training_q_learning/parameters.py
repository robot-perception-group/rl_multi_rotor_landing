...
class UAVParameters():
    def __init__(self):
        ...
        self.drone_name = "hummingbird" #name of drone. Needs to match the one used to start up the environment.
        ...
        #Maximum pitch angle
        self.action_max_values = {"pitch":(M_PI/180)*21.377, #rad
                                  }
        #Maximum roll angle      
        self.action_delta_values = {"pitch":(M_PI/180)*7.1257, #rad
                                  }                          
        ...
        self.observation_max_values = {"rel_p_x":4.5, #[m], float
                                       "rel_v_x":3.39, #[m/s], float
                                       "rel_a_x":0.53, #[m/s^2], float
                                        }
        return
...
class RLParameters():
    def __init__(self):
        ...
        self.scale_modification_value["Q_table"] = [0.8164, 0.8201, 0.8245, 0.8297, 0.8358]  # List of floats  - Values specifying the scale factors applied to the values of the copied tables                                  
        self.scale_modification_value["Q_table_double"] = [0.8164, 0.8201, 0.8245, 0.8297, 0.8358]  # List of floats  - Values specifying the scale factors applied to the values of the copied tables                   
        ...
        self.curriculum_step =  0  # Int, indexing starts with 0
...
class SimulationParameters(UAVParameters):
    def __init__(self):
        ...
        self.init_max_x = np.array([0,4.5])     #array of floats
        self.init_min_x = np.array([-4.5,0])    #array of floats
        self.init_max_y = np.array([0,4.5])     #array of floats
        self.init_min_y = np.array([-4.5,0])    #array of floats
        ...
        self.touch_down_height = 0.4 #[m] float
        ...
        self.max_abs_p_x = 4.5 #[m] float
        self.max_abs_p_y = 4.5 #[m] float
