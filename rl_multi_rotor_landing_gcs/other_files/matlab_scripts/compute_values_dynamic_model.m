...
% script determines the value v0 that is required for compliance with 
% a mass point model that is subjected to constant acceleration.
% The values in the vector timesteps can be specified to determine the
% values that need to be entered in the config files

% Currently, the model does only deal with the same discretization of the
% acceleration for all refinement steps.

% For retrieving the values, have a look at the variables list
