...
class LandingSimulationObject():
    ...
    def __init__(self,drone_name,ros_port,gaz_port,ros_ip):#Add the simulation parameters here
        ...
        #Set up publisher
        self.relative_reward_publisher = get_publisher(self.topic_prefix+'training/relative_change_reward',Float64,queue_size = 0,ros_ip = ros_ip,ros_port = ros_port,gaz_port = gaz_port)
        self.reward_current_state_publisher = get_publisher(self.topic_prefix+'training/current_state_reward',Float64,queue_size = 0,ros_ip = ros_ip,ros_port = ros_port,gaz_port = gaz_port)
        self.cum_reward_publisher = get_publisher(self.topic_prefix+'training/episode_cum_reward',Float64,queue_size = 0,ros_ip = ros_ip,ros_port = ros_port,gaz_port = gaz_port)
        self.reward_rel_pos_publisher = get_publisher(self.topic_prefix+'training/reward_rel_pos',Float64,queue_size = 0,ros_ip = ros_ip,ros_port = ros_port,gaz_port = gaz_port)
        self.reward_rel_vel_publisher = get_publisher(self.topic_prefix+'training/reward_rel_vel',Float64,queue_size = 0,ros_ip = ros_ip,ros_port = ros_port,gaz_port = gaz_port)
        self.reward_action_publisher = get_publisher(self.topic_prefix+'training/reward_action',Float64,queue_size = 0,ros_ip = ros_ip,ros_port = ros_port,gaz_port = gaz_port)
        self.current_idx_publisher = get_publisher(self.topic_prefix+'training/current_idx',Float64MultiArray,queue_size = 0,ros_ip = ros_ip,ros_port = ros_port,gaz_port = gaz_port)
