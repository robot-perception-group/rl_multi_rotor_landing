...
roslaunch training_q_learning vicon_publish_state_estimate_copter_frame.launch drone_name:=$DRONE_NAME ros_port:=$ROS_PORT gaz_port:=$GAZ_PORT ros_ip:=$ROS_IP